    ...
    switch csIDX
        case 0          % Delete files
            ...
            prompt = {[newline,'\fontsize{9}','\bf',sprintf(['First, enter information related to X_d and Y_d:\n\n']),...
                ...
                '\rm 1. Enter an array of values for X coordinates in [m]:'],...
                '\fontsize{9} 2. Enter an array of values for Y coordinates in [m]:',...
                ['\fontsize{9}','\bf',sprintf('Second, enter wave propagation velocity information:\n\n'),...
                '\rm',' 3. Enter the mean value of the velocity in [m/s]'],...
                '\fontsize{9} 4. Enter the standard deviation of the velocity:',...
                ['\fontsize{9}','\bf',...
                sprintf('Third, enter number of samples used for the objective function evaluation:\n\n'),...
                '\rm 5. Enter number of samples:']};
            ...
            V_mean = str2double(X_Y_d_v_V{3});
            V_std = str2double(X_Y_d_v_V{4});
            N_smpl = str2double(X_Y_d_v_V{5}); % Number of samples for the MC integrals
            ...
            if isfile(my_file)
                ...
                prior_smpl=priorSmpl(N_smpl,X_d_v,Y_d_v,V_mean,V_std);
            end
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
