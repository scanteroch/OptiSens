...
def priorSmpl(N_smpl,X_d_v,Y_d_v, a_mean, a_std, b_mean, b_std):
###############################################################################
#   Input paramters:
...
###############################################################################
    ...
    a=np.random.normal(a_mean, a_std, N_smpl)
    b=np.random.normal(b_mean, b_std, N_smpl)
    
    prior_smpl=np.squeeze(np.array([[xd],[yd],[a],[b]]))
...
def P_fun_py(xs, ys, xa, ya, xd, yd, a, b):
###############################################################################
#   Input paramters:
...
###############################################################################
    return np.array([[(-(np.sqrt((xa - xd)**2 + (ya - yd)**2)*((2*a**4*(-ya + yd)**2)/(b**2*(-xa + xd)**3*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) + (2*a**4*(-ya + yd)**4)/(b**2*(-xa + xd)**5*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) - (2*a**2*(-ya + yd)**2)/((-xa + xd)**3*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)))))/(2.*(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))**1.5) - (xa - xd)/(np.sqrt((xa - xd)**2 + (ya - yd)**2)*np.sqrt(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))) - (np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*((-2*a**4*(-yd + ys)**2)/(b**2*(-xd + xs)**3*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) - (2*a**4*(-yd + ys)**4)/(b**2*(-xd + xs)**5*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) + (2*a**2*(-yd + ys)**2)/((-xd + xs)**3*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)))))/(2.*(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))**1.5) - (-xd + xs)/(np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*np.sqrt(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))))**2,\
	(-(np.sqrt((xa - xd)**2 + (ya - yd)**2)*((2*a**4*(-ya + yd)**2)/(b**2*(-xa + xd)**3*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) + (2*a**4*(-ya + yd)**4)/(b**2*(-xa + xd)**5*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) - (2*a**2*(-ya + yd)**2)/((-xa + xd)**3*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)))))/(2.*(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))**1.5) - (xa - xd)/(np.sqrt((xa - xd)**2 + (ya - yd)**2)*np.sqrt(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))) - (np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*((-2*a**4*(-yd + ys)**2)/(b**2*(-xd + xs)**3*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) - (2*a**4*(-yd + ys)**4)/(b**2*(-xd + xs)**5*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) + (2*a**2*(-yd + ys)**2)/((-xd + xs)**3*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)))))/(2.*(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))**1.5) - (-xd + xs)/(np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*np.sqrt(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))))*(-(np.sqrt((xa - xd)**2 + (ya - yd)**2)*((-2*a**4*(-ya + yd))/(b**2*(-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) - (2*a**4*(-ya + yd)**3)/(b**2*(-xa + xd)**4*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) + (2*a**2*(-ya + yd))/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)))))/(2.*(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))**1.5) - (ya - yd)/(np.sqrt((xa - xd)**2 + (ya - yd)**2)*np.sqrt(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))) - (np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*((2*a**4*(-yd + ys))/(b**2*(-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) + (2*a**4*(-yd + ys)**3)/(b**2*(-xd + xs)**4*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) - (2*a**2*(-yd + ys))/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)))))/(2.*(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))**1.5) - (-yd + ys)/(np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*np.sqrt(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)))))),\
	(-(np.sqrt((xa - xd)**2 + (ya - yd)**2)*((-2*a**3*(-ya + yd)**2)/(b**2*(-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) - (2*a**3*(-ya + yd)**4)/(b**2*(-xa + xd)**4*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) + (2*a)/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (2*a*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)))))/(2.*(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))**1.5) - (np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*((-2*a**3*(-yd + ys)**2)/(b**2*(-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) - (2*a**3*(-yd + ys)**4)/(b**2*(-xd + xs)**4*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) + (2*a)/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (2*a*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)))))/(2.*(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))**1.5))*(-(np.sqrt((xa - xd)**2 + (ya - yd)**2)*((2*a**4*(-ya + yd)**2)/(b**2*(-xa + xd)**3*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) + (2*a**4*(-ya + yd)**4)/(b**2*(-xa + xd)**5*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) - (2*a**2*(-ya + yd)**2)/((-xa + xd)**3*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)))))/(2.*(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))**1.5) - (xa - xd)/(np.sqrt((xa - xd)**2 + (ya - yd)**2)*np.sqrt(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))) - (np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*((-2*a**4*(-yd + ys)**2)/(b**2*(-xd + xs)**3*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) - (2*a**4*(-yd + ys)**4)/(b**2*(-xd + xs)**5*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) + (2*a**2*(-yd + ys)**2)/((-xd + xs)**3*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)))))/(2.*(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))**1.5) - (-xd + xs)/(np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*np.sqrt(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)))))),\
	(-(np.sqrt((xa - xd)**2 + (ya - yd)**2)*((2*a**4*(-ya + yd)**2)/(b**3*(-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) + (2*a**4*(-ya + yd)**4)/(b**3*(-xa + xd)**4*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2)))/(2.*(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))**1.5) - (np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*((2*a**4*(-yd + ys)**2)/(b**3*(-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) + (2*a**4*(-yd + ys)**4)/(b**3*(-xd + xs)**4*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2)))/(2.*(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))**1.5))*(-(np.sqrt((xa - xd)**2 + (ya - yd)**2)*((2*a**4*(-ya + yd)**2)/(b**2*(-xa + xd)**3*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) + (2*a**4*(-ya + yd)**4)/(b**2*(-xa + xd)**5*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) - (2*a**2*(-ya + yd)**2)/((-xa + xd)**3*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)))))/(2.*(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))**1.5) - (xa - xd)/(np.sqrt((xa - xd)**2 + (ya - yd)**2)*np.sqrt(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))) - (np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*((-2*a**4*(-yd + ys)**2)/(b**2*(-xd + xs)**3*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) - (2*a**4*(-yd + ys)**4)/(b**2*(-xd + xs)**5*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) + (2*a**2*(-yd + ys)**2)/((-xd + xs)**3*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)))))/(2.*(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))**1.5) - (-xd + xs)/(np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*np.sqrt(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))))],\
	[(-(np.sqrt((xa - xd)**2 + (ya - yd)**2)*((2*a**4*(-ya + yd)**2)/(b**2*(-xa + xd)**3*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) + (2*a**4*(-ya + yd)**4)/(b**2*(-xa + xd)**5*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) - (2*a**2*(-ya + yd)**2)/((-xa + xd)**3*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)))))/(2.*(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))**1.5) - (xa - xd)/(np.sqrt((xa - xd)**2 + (ya - yd)**2)*np.sqrt(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))) - (np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*((-2*a**4*(-yd + ys)**2)/(b**2*(-xd + xs)**3*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) - (2*a**4*(-yd + ys)**4)/(b**2*(-xd + xs)**5*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) + (2*a**2*(-yd + ys)**2)/((-xd + xs)**3*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)))))/(2.*(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))**1.5) - (-xd + xs)/(np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*np.sqrt(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))))*(-(np.sqrt((xa - xd)**2 + (ya - yd)**2)*((-2*a**4*(-ya + yd))/(b**2*(-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) - (2*a**4*(-ya + yd)**3)/(b**2*(-xa + xd)**4*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) + (2*a**2*(-ya + yd))/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)))))/(2.*(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))**1.5) - (ya - yd)/(np.sqrt((xa - xd)**2 + (ya - yd)**2)*np.sqrt(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))) - (np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*((2*a**4*(-yd + ys))/(b**2*(-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) + (2*a**4*(-yd + ys)**3)/(b**2*(-xd + xs)**4*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) - (2*a**2*(-yd + ys))/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)))))/(2.*(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))**1.5) - (-yd + ys)/(np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*np.sqrt(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)))))),\
	(-(np.sqrt((xa - xd)**2 + (ya - yd)**2)*((-2*a**4*(-ya + yd))/(b**2*(-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) - (2*a**4*(-ya + yd)**3)/(b**2*(-xa + xd)**4*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) + (2*a**2*(-ya + yd))/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)))))/(2.*(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))**1.5) - (ya - yd)/(np.sqrt((xa - xd)**2 + (ya - yd)**2)*np.sqrt(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))) - (np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*((2*a**4*(-yd + ys))/(b**2*(-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) + (2*a**4*(-yd + ys)**3)/(b**2*(-xd + xs)**4*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) - (2*a**2*(-yd + ys))/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)))))/(2.*(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))**1.5) - (-yd + ys)/(np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*np.sqrt(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))))**2,\
	(-(np.sqrt((xa - xd)**2 + (ya - yd)**2)*((-2*a**3*(-ya + yd)**2)/(b**2*(-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) - (2*a**3*(-ya + yd)**4)/(b**2*(-xa + xd)**4*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) + (2*a)/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (2*a*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)))))/(2.*(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))**1.5) - (np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*((-2*a**3*(-yd + ys)**2)/(b**2*(-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) - (2*a**3*(-yd + ys)**4)/(b**2*(-xd + xs)**4*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) + (2*a)/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (2*a*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)))))/(2.*(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))**1.5))*(-(np.sqrt((xa - xd)**2 + (ya - yd)**2)*((-2*a**4*(-ya + yd))/(b**2*(-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) - (2*a**4*(-ya + yd)**3)/(b**2*(-xa + xd)**4*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) + (2*a**2*(-ya + yd))/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)))))/(2.*(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))**1.5) - (ya - yd)/(np.sqrt((xa - xd)**2 + (ya - yd)**2)*np.sqrt(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))) - (np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*((2*a**4*(-yd + ys))/(b**2*(-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) + (2*a**4*(-yd + ys)**3)/(b**2*(-xd + xs)**4*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) - (2*a**2*(-yd + ys))/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)))))/(2.*(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))**1.5) - (-yd + ys)/(np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*np.sqrt(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)))))),\
	(-(np.sqrt((xa - xd)**2 + (ya - yd)**2)*((2*a**4*(-ya + yd)**2)/(b**3*(-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) + (2*a**4*(-ya + yd)**4)/(b**3*(-xa + xd)**4*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2)))/(2.*(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))**1.5) - (np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*((2*a**4*(-yd + ys)**2)/(b**3*(-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) + (2*a**4*(-yd + ys)**4)/(b**3*(-xd + xs)**4*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2)))/(2.*(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))**1.5))*(-(np.sqrt((xa - xd)**2 + (ya - yd)**2)*((-2*a**4*(-ya + yd))/(b**2*(-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) - (2*a**4*(-ya + yd)**3)/(b**2*(-xa + xd)**4*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) + (2*a**2*(-ya + yd))/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)))))/(2.*(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))**1.5) - (ya - yd)/(np.sqrt((xa - xd)**2 + (ya - yd)**2)*np.sqrt(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))) - (np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*((2*a**4*(-yd + ys))/(b**2*(-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) + (2*a**4*(-yd + ys)**3)/(b**2*(-xd + xs)**4*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) - (2*a**2*(-yd + ys))/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)))))/(2.*(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))**1.5) - (-yd + ys)/(np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*np.sqrt(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))))],\
	[(-(np.sqrt((xa - xd)**2 + (ya - yd)**2)*((-2*a**3*(-ya + yd)**2)/(b**2*(-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) - (2*a**3*(-ya + yd)**4)/(b**2*(-xa + xd)**4*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) + (2*a)/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (2*a*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)))))/(2.*(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))**1.5) - (np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*((-2*a**3*(-yd + ys)**2)/(b**2*(-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) - (2*a**3*(-yd + ys)**4)/(b**2*(-xd + xs)**4*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) + (2*a)/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (2*a*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)))))/(2.*(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))**1.5))*(-(np.sqrt((xa - xd)**2 + (ya - yd)**2)*((2*a**4*(-ya + yd)**2)/(b**2*(-xa + xd)**3*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) + (2*a**4*(-ya + yd)**4)/(b**2*(-xa + xd)**5*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) - (2*a**2*(-ya + yd)**2)/((-xa + xd)**3*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)))))/(2.*(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))**1.5) - (xa - xd)/(np.sqrt((xa - xd)**2 + (ya - yd)**2)*np.sqrt(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))) - (np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*((-2*a**4*(-yd + ys)**2)/(b**2*(-xd + xs)**3*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) - (2*a**4*(-yd + ys)**4)/(b**2*(-xd + xs)**5*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) + (2*a**2*(-yd + ys)**2)/((-xd + xs)**3*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)))))/(2.*(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))**1.5) - (-xd + xs)/(np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*np.sqrt(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)))))),\
	(-(np.sqrt((xa - xd)**2 + (ya - yd)**2)*((-2*a**3*(-ya + yd)**2)/(b**2*(-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) - (2*a**3*(-ya + yd)**4)/(b**2*(-xa + xd)**4*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) + (2*a)/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (2*a*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)))))/(2.*(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))**1.5) - (np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*((-2*a**3*(-yd + ys)**2)/(b**2*(-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) - (2*a**3*(-yd + ys)**4)/(b**2*(-xd + xs)**4*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) + (2*a)/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (2*a*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)))))/(2.*(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))**1.5))*(-(np.sqrt((xa - xd)**2 + (ya - yd)**2)*((-2*a**4*(-ya + yd))/(b**2*(-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) - (2*a**4*(-ya + yd)**3)/(b**2*(-xa + xd)**4*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) + (2*a**2*(-ya + yd))/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)))))/(2.*(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))**1.5) - (ya - yd)/(np.sqrt((xa - xd)**2 + (ya - yd)**2)*np.sqrt(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))) - (np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*((2*a**4*(-yd + ys))/(b**2*(-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) + (2*a**4*(-yd + ys)**3)/(b**2*(-xd + xs)**4*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) - (2*a**2*(-yd + ys))/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)))))/(2.*(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))**1.5) - (-yd + ys)/(np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*np.sqrt(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)))))),\
	(-(np.sqrt((xa - xd)**2 + (ya - yd)**2)*((-2*a**3*(-ya + yd)**2)/(b**2*(-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) - (2*a**3*(-ya + yd)**4)/(b**2*(-xa + xd)**4*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) + (2*a)/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (2*a*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)))))/(2.*(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))**1.5) - (np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*((-2*a**3*(-yd + ys)**2)/(b**2*(-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) - (2*a**3*(-yd + ys)**4)/(b**2*(-xd + xs)**4*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) + (2*a)/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (2*a*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)))))/(2.*(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))**1.5))**2,\
	(-(np.sqrt((xa - xd)**2 + (ya - yd)**2)*((2*a**4*(-ya + yd)**2)/(b**3*(-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) + (2*a**4*(-ya + yd)**4)/(b**3*(-xa + xd)**4*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2)))/(2.*(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))**1.5) - (np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*((2*a**4*(-yd + ys)**2)/(b**3*(-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) + (2*a**4*(-yd + ys)**4)/(b**3*(-xd + xs)**4*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2)))/(2.*(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))**1.5))*(-(np.sqrt((xa - xd)**2 + (ya - yd)**2)*((-2*a**3*(-ya + yd)**2)/(b**2*(-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) - (2*a**3*(-ya + yd)**4)/(b**2*(-xa + xd)**4*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) + (2*a)/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (2*a*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)))))/(2.*(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))**1.5) - (np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*((-2*a**3*(-yd + ys)**2)/(b**2*(-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) - (2*a**3*(-yd + ys)**4)/(b**2*(-xd + xs)**4*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) + (2*a)/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (2*a*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)))))/(2.*(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))**1.5))],\
	[(-(np.sqrt((xa - xd)**2 + (ya - yd)**2)*((2*a**4*(-ya + yd)**2)/(b**3*(-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) + (2*a**4*(-ya + yd)**4)/(b**3*(-xa + xd)**4*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2)))/(2.*(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))**1.5) - (np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*((2*a**4*(-yd + ys)**2)/(b**3*(-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) + (2*a**4*(-yd + ys)**4)/(b**3*(-xd + xs)**4*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2)))/(2.*(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))**1.5))*(-(np.sqrt((xa - xd)**2 + (ya - yd)**2)*((2*a**4*(-ya + yd)**2)/(b**2*(-xa + xd)**3*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) + (2*a**4*(-ya + yd)**4)/(b**2*(-xa + xd)**5*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) - (2*a**2*(-ya + yd)**2)/((-xa + xd)**3*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)))))/(2.*(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))**1.5) - (xa - xd)/(np.sqrt((xa - xd)**2 + (ya - yd)**2)*np.sqrt(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))) - (np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*((-2*a**4*(-yd + ys)**2)/(b**2*(-xd + xs)**3*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) - (2*a**4*(-yd + ys)**4)/(b**2*(-xd + xs)**5*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) + (2*a**2*(-yd + ys)**2)/((-xd + xs)**3*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)))))/(2.*(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))**1.5) - (-xd + xs)/(np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*np.sqrt(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)))))),\
	(-(np.sqrt((xa - xd)**2 + (ya - yd)**2)*((2*a**4*(-ya + yd)**2)/(b**3*(-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) + (2*a**4*(-ya + yd)**4)/(b**3*(-xa + xd)**4*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2)))/(2.*(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))**1.5) - (np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*((2*a**4*(-yd + ys)**2)/(b**3*(-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) + (2*a**4*(-yd + ys)**4)/(b**3*(-xd + xs)**4*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2)))/(2.*(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))**1.5))*(-(np.sqrt((xa - xd)**2 + (ya - yd)**2)*((-2*a**4*(-ya + yd))/(b**2*(-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) - (2*a**4*(-ya + yd)**3)/(b**2*(-xa + xd)**4*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) + (2*a**2*(-ya + yd))/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)))))/(2.*(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))**1.5) - (ya - yd)/(np.sqrt((xa - xd)**2 + (ya - yd)**2)*np.sqrt(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))) - (np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*((2*a**4*(-yd + ys))/(b**2*(-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) + (2*a**4*(-yd + ys)**3)/(b**2*(-xd + xs)**4*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) - (2*a**2*(-yd + ys))/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)))))/(2.*(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))**1.5) - (-yd + ys)/(np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*np.sqrt(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)))))),\
	(-(np.sqrt((xa - xd)**2 + (ya - yd)**2)*((2*a**4*(-ya + yd)**2)/(b**3*(-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) + (2*a**4*(-ya + yd)**4)/(b**3*(-xa + xd)**4*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2)))/(2.*(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))**1.5) - (np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*((2*a**4*(-yd + ys)**2)/(b**3*(-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) + (2*a**4*(-yd + ys)**4)/(b**3*(-xd + xs)**4*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2)))/(2.*(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))**1.5))*(-(np.sqrt((xa - xd)**2 + (ya - yd)**2)*((-2*a**3*(-ya + yd)**2)/(b**2*(-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) - (2*a**3*(-ya + yd)**4)/(b**2*(-xa + xd)**4*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) + (2*a)/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (2*a*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)))))/(2.*(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))**1.5) - (np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*((-2*a**3*(-yd + ys)**2)/(b**2*(-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) - (2*a**3*(-yd + ys)**4)/(b**2*(-xd + xs)**4*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) + (2*a)/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (2*a*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)))))/(2.*(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))**1.5)),\
	(-(np.sqrt((xa - xd)**2 + (ya - yd)**2)*((2*a**4*(-ya + yd)**2)/(b**3*(-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2) + (2*a**4*(-ya + yd)**4)/(b**3*(-xa + xd)**4*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))**2)))/(2.*(a**2/(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2)) + (a**2*(-ya + yd)**2)/((-xa + xd)**2*(1 + (a**2*(-ya + yd)**2)/(b**2*(-xa + xd)**2))))**1.5) - (np.sqrt((-xd + xs)**2 + (-yd + ys)**2)*((2*a**4*(-yd + ys)**2)/(b**3*(-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2) + (2*a**4*(-yd + ys)**4)/(b**3*(-xd + xs)**4*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))**2)))/(2.*(a**2/(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2)) + (a**2*(-yd + ys)**2)/((-xd + xs)**2*(1 + (a**2*(-yd + ys)**2)/(b**2*(-xd + xs)**2))))**1.5))**2]])

# Function: Evaluation of P matrices
def P_eval(GridPtX,GridPtY,prior_smpl):
###############################################################################
#   Input paramters:
#       GridPtX,GridPtY -   X and Y coordinates of the grid points of
#                           possible sensor/actuator locations
...
###############################################################################
    NmaxSns=len(GridPtX)
    NmaxAct=len(GridPtX)
    P_sns_eval=P_fun_py(np.array([np.tile(GridPtX[j],(NmaxAct,N_smpl)) for j in np.arange(NmaxSns)]), np.array([np.tile(GridPtY[j],(NmaxAct,N_smpl)) for j in np.arange(NmaxSns)]), np.tile(np.array([np.repeat(GridPtX[l],N_smpl) for l in np.arange(NmaxAct)]),(NmaxSns,1,1)), np.tile(np.array([np.repeat(GridPtY[l],N_smpl) for l in np.arange(NmaxAct)]),(NmaxSns,1,1)), np.tile(prior_smpl[0,:],(NmaxSns,NmaxAct,1)), np.tile(prior_smpl[1,:],(NmaxSns,NmaxAct,1)), np.tile(prior_smpl[2,:],(NmaxSns,NmaxAct,1)), np.tile(prior_smpl[3,:],(NmaxSns,NmaxAct,1)))
...
###############################################################################
    z=np.array(candSol[0:NmaxAct]) # Vector for the sensors
    w=np.array(candSol[NmaxAct:2*NmaxAct]) # Vector for the actuators
...
if my_file.is_file()==0:
    P_eval(GridPtX,GridPtY,prior_smpl)
...
with open("./res/Output.txt", 'w') as text_file :
    print('ENTROPY-BASED CONVEX OPTIMIZATION - COMPOSITE PLATE\nOptimal sensor and actuator solution\n',file=text_file)
